...
export async function POST(req: Request) {
  ...
  const shipment = await prisma.shipment.create({
    data: {
      ...
      acceptsVehicles: data.acceptsVehicles ?? false,
      acceptsDrums: data.acceptsDrums ?? false,
      acceptsSizedCartons: data.acceptsSizedCartons ?? false,
      ...
      ratePerVehicle: data.ratePerVehicle ?? null,
      rateDrumSmall: data.rateDrumSmall ?? null,
      rateDrumMedium: data.rateDrumMedium ?? null,
      rateDrumLarge: data.rateDrumLarge ?? null,
      rateCartonSmall: data.rateCartonSmall ?? null,
      rateCartonMedium: data.rateCartonMedium ?? null,
      rateCartonLarge: data.rateCartonLarge ?? null,
